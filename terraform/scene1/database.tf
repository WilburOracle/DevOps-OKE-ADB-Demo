...
resource oci_database_autonomous_database export_ADB-Demo {
  ...
  defined_tags = {
    ...
    "default_tags.CreatedOn" = "2025-09-22T00:52:30.008Z"
  }
  ...
  private_endpoint_ip    = "10.0.10.35"
  private_endpoint_label = "kf4c11fo"
